...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _domControl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domControl */ \"./src/domControl.js\");\n \n// let jap = new Player(\"Jap\", 1);\n// jap.gameBoard.populateBoard(0, 0, \"h\", 3);\n// jap.gameBoard.populateBoard(8, 0, \"v\", 5);\n\n_domControl__WEBPACK_IMPORTED_MODULE_0__.comp.gameBoard.populateBoard(2, 0, \"h\", 5);\n_domControl__WEBPACK_IMPORTED_MODULE_0__.comp.gameBoard.populateBoard(3, 5, \"v\", 3);\n\nfunction playerAttack() {\n  let squares = document.querySelectorAll(\".board-2 div\");\n  squares.forEach((square) => {\n    square.addEventListener(\"click\", getAttack, { once: true });\n  });\n}\n\nfunction getAttack() {\n  let x = this.getAttribute(\"data-column\");\n  let y = this.getAttribute(\"data-row\");\n\n  let status = _domControl__WEBPACK_IMPORTED_MODULE_0__.player1.attack(x, y, _domControl__WEBPACK_IMPORTED_MODULE_0__.comp);\n  (0,_domControl__WEBPACK_IMPORTED_MODULE_0__.recordAttack)(x,y, 2, status)\n  if (_domControl__WEBPACK_IMPORTED_MODULE_0__.comp.gameBoard.isGameOver() || _domControl__WEBPACK_IMPORTED_MODULE_0__.player1.gameBoard.isGameOver()) {\n    console.log(\"YOU WIN\");\n    let squares = document.querySelectorAll(\".board-2 div\");\n    squares.forEach((square) => {\n      square.removeEventListener(\"click\", getAttack);\n    });\n    return;\n  }\n\n  computerAttack();\n}\n\nfunction computerAttack() {\n  let x = Math.floor(Math.random() * 10);\n  let y = Math.floor(Math.random() * 10);\n  console.log(_domControl__WEBPACK_IMPORTED_MODULE_0__.player1.gameBoard.missedShots.includes(`${x}${y}`));\n\n  while (_domControl__WEBPACK_IMPORTED_MODULE_0__.player1.gameBoard.missedShots.includes(`${x}${y}`)) {\n    x = Math.floor(Math.random() * 10);\n    y = Math.floor(Math.random() * 10);\n  }\n\n  let status = _domControl__WEBPACK_IMPORTED_MODULE_0__.comp.attack(x, y, _domControl__WEBPACK_IMPORTED_MODULE_0__.player1);\n  (0,_domControl__WEBPACK_IMPORTED_MODULE_0__.recordAttack)(x,y, 1 , status);\n}\n(0,_domControl__WEBPACK_IMPORTED_MODULE_0__.prepareBoard)();\nplayerAttack();\n\n\n//# sourceURL=webpack://battleship/./src/index.js?");
